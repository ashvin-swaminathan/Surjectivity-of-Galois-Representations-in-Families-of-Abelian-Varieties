...
Before proceeding with the proof, we set some notation and assumptions, which will remain in place for the remainder of this section. In what follows, we retain the setting of Theorem~\ref{theorem:main}.
\begin{enumerate}
